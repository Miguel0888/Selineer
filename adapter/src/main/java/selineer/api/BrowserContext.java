 ...
 */
 ...
 public interface BrowserContext extends AutoCloseable {
    ...
    * also fire for popup pages. See also {@link selineer.api.microsoft.playwright.Page#onPopup Page.onPopup()} to receive events about
    ...
    * use {@link selineer.api.microsoft.playwright.Page#onPageError Page.onPageError()} instead.
    */
    ...
    * listen for requests from a particular page, use {@link selineer.api.microsoft.playwright.Page#onRequest Page.onRequest()}.
    *
    * <p> In order to intercept and mutate requests, see {@link selineer.api.microsoft.playwright.BrowserContext#route
    * BrowserContext.route()} or {@link selineer.api.microsoft.playwright.Page#route Page.route()}.
    */
    ...
    * {@link selineer.api.microsoft.playwright.Page#onRequestFailed Page.onRequestFailed()}.
    *
    ...
    * with {@link selineer.api.microsoft.playwright.BrowserContext#onRequestFinished BrowserContext.onRequestFinished()} event and not
    * with {@link selineer.api.microsoft.playwright.BrowserContext#onRequestFailed BrowserContext.onRequestFailed()}.
    */
    ...
    * from a particular page, use {@link selineer.api.microsoft.playwright.Page#onRequestFinished Page.onRequestFinished()}.
    */
    ...
    * use {@link selineer.api.microsoft.playwright.Page#onResponse Page.onResponse()}.
    */
    ...
    * obtained via {@link selineer.api.microsoft.playwright.BrowserContext#cookies BrowserContext.cookies()}.
    *
    * <p> <strong>Usage</strong>
    * <pre>{@code
    ...
    *
    * <p> See {@link selineer.api.microsoft.playwright.Page#exposeBinding Page.exposeBinding()} for page-only version.
    *
    * <p> <strong>Usage</strong>
    *
    ...
    * awaited.
    *
    * <p> See {@link selineer.api.microsoft.playwright.Page#exposeFunction Page.exposeFunction()} for page-only version.
    *
    * <p> <strong>Usage</strong>
    *
    ...
    *
    * <p> <strong>NOTE:</strong> {@link selineer.api.microsoft.playwright.BrowserContext#route BrowserContext.route()} will not intercept requests intercepted by
    ...
    * }</pre>
    *
    * <p> Page routes (set up with {@link selineer.api.microsoft.playwright.Page#route Page.route()}) take precedence over browser context
    * routes when request matches both handlers.
    *
    * <p> To remove a route with its handler you can use {@link selineer.api.microsoft.playwright.BrowserContext#unroute
    ...
    * </ul>
    *
    * <p> <strong>NOTE:</strong> {@link selineer.api.microsoft.playwright.Page#setDefaultNavigationTimeout Page.setDefaultNavigationTimeout()} and {@link
    * selineer.api.microsoft.playwright.Page#setDefaultTimeout Page.setDefaultTimeout()} take priority over {@link
    ...
    *
    * <p> <strong>NOTE:</strong> {@link selineer.api.microsoft.playwright.Page#setDefaultNavigationTimeout Page.setDefaultNavigationTimeout()}, {@link
    * selineer.api.microsoft.playwright.Page#setDefaultTimeout Page.setDefaultTimeout()} and {@link
    * selineer.api.microsoft.playwright.BrowserContext#setDefaultNavigationTimeout BrowserContext.setDefaultNavigationTimeout()} take
    * priority over {@link selineer.api.microsoft.playwright.BrowserContext#setDefaultTimeout BrowserContext.setDefaultTimeout()}.
    *
    ...
    * with page-specific extra HTTP headers set with {@link selineer.api.microsoft.playwright.Page#setExtraHTTPHeaders
    ...
    *
    * <p> <strong>NOTE:</strong> {@link selineer.api.microsoft.playwright.BrowserContext#setExtraHTTPHeaders BrowserContext.setExtraHTTPHeaders()} does not
    ...
    * }</pre>
    *
    * <p> <strong>NOTE:</strong> Consider using {@link selineer.api.microsoft.playwright.BrowserContext#grantPermissions BrowserContext.grantPermissions()} to
   ...
   Tracing tracing();
   /**
    * Removes all routes created with {@link selineer.api.microsoft.playwright.BrowserContext#route BrowserContext.route()} and {@link
    * selineer.api.microsoft.playwright.BrowserContext#routeFromHAR BrowserContext.routeFromHAR()}.
    *
    * @since v1.41
    */
   void unrouteAll();
   /**
    * Removes a route created with {@link selineer.api.microsoft.playwright.BrowserContext#route BrowserContext.route()}. When {@code
    ...
    * selineer.api.microsoft.playwright.BrowserContext#route BrowserContext.route()}.
    * @since v1.8
    */
    ...
    * @param url A glob pattern, regex pattern or predicate receiving [URL] used to register a routing with {@link
    * selineer.api.microsoft.playwright.BrowserContext#route BrowserContext.route()}.
    * @param handler Optional handler function used to register a routing with {@link selineer.api.microsoft.playwright.BrowserContext#route
    ...
    * selineer.api.microsoft.playwright.BrowserContext#onConsoleMessage BrowserContext.onConsoleMessage()} event is fired.
    *
