...
import com.microsoft.playwright.impl.ChromeDevProtocolHelper.NavigationHelper;
...
public class PageImpl implements Page {
    ...
    public PageImpl(WebSocketClient webSocketClient) {
    ...
    public Response navigate(String url, NavigateOptions options) {
        ...
        try {
            ...
            // Erstelle und returniere ResponseImpl
            return new ResponseImpl(body, status, statusText, url, new HashMap<>(), null, false);
