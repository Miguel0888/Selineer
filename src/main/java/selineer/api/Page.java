...
// Packages & Imports changed!
package selineer.api;

import selineer.api.options.*;
...
public interface Page extends AutoCloseable {
   ...
   * }</pre>
   *
   * <p> <strong>NOTE:</strong> When no {@link selineer.api.microsoft.playwright.Page#onDialog Page.onDialog()} or {@link
   * selineer.api.microsoft.playwright.BrowserContext#onDialog BrowserContext.onDialog()} listeners are present, all dialogs are
   ...
   * selineer.api.microsoft.playwright.BrowserContext#onPage BrowserContext.onPage()}, but only for popups relevant to this page.
   *
   ...
   * this network request, use {@link selineer.api.microsoft.playwright.BrowserContext#route BrowserContext.route()} and {@link
   * selineer.api.microsoft.playwright.BrowserContext#onRequest BrowserContext.onRequest()} respectively instead of similar methods on
   * the {@code Page}.
   * <pre>{@code
   ...
   * }</pre>
   *
   * <p> <strong>NOTE:</strong> Use {@link selineer.api.microsoft.playwright.Page#waitForLoadState Page.waitForLoadState()} to wait until the page gets to a
   ...
   * {@link selineer.api.microsoft.playwright.Page#route Page.route()} or {@link selineer.api.microsoft.playwright.BrowserContext#route
   ...
   * with {@link selineer.api.microsoft.playwright.Page#onRequestFinished Page.onRequestFinished()} event and not with {@link
   * selineer.api.microsoft.playwright.Page#onRequestFailed Page.onRequestFailed()}. A request will only be considered failed when the
  ...
  class CheckOptions {
     ...
     * value can be changed by using the {@link selineer.api.microsoft.playwright.BrowserContext#setDefaultTimeout
     * BrowserContext.setDefaultTimeout()} or {@link selineer.api.microsoft.playwright.Page#setDefaultTimeout Page.setDefaultTimeout()}
     * methods.
     */
  ...
  class GoBackOptions {
     ...
     * be changed by using the {@link selineer.api.microsoft.playwright.BrowserContext#setDefaultNavigationTimeout
     * BrowserContext.setDefaultNavigationTimeout()}, {@link selineer.api.microsoft.playwright.BrowserContext#setDefaultTimeout
     * BrowserContext.setDefaultTimeout()}, {@link selineer.api.microsoft.playwright.Page#setDefaultNavigationTimeout
     * Page.setDefaultNavigationTimeout()} or {@link selineer.api.microsoft.playwright.Page#setDefaultTimeout Page.setDefaultTimeout()}
     * methods.
     */
    public Double timeout;
    /**
  ...
  class NavigateOptions {
     ...
     * selineer.api.microsoft.playwright.Page#setExtraHTTPHeaders Page.setExtraHTTPHeaders()}.
     */
  ...
  class IsHiddenOptions {
    ...
    public Boolean strict;
    /**
     * @deprecated This option is ignored. {@link selineer.api.microsoft.playwright.Page#isHidden Page.isHidden()} does not wait for the element to
  ...
  class IsVisibleOptions {
    ...
    public Boolean strict;
    /**
     * @deprecated This option is ignored. {@link selineer.api.microsoft.playwright.Page#isVisible Page.isVisible()} does not wait for the element
  ...
  class RouteFromHAROptions {
     ...
     * written to disk when {@link selineer.api.microsoft.playwright.BrowserContext#close BrowserContext.close()} is called.
     */
  ...
  class WaitForCloseOptions {
     ...
     * default value can be changed by using the {@link selineer.api.microsoft.playwright.BrowserContext#setDefaultTimeout
  ...
  class WaitForRequestOptions {
     ...
     * be changed by using the {@link selineer.api.microsoft.playwright.Page#setDefaultTimeout Page.setDefaultTimeout()} method.
     */
    public Double timeout;
  ...
  class WaitForResponseOptions {
    /**
     * Maximum wait time in milliseconds, defaults to 30 seconds, pass {@code 0} to disable the timeout. The default value can
     * be changed by using the {@link selineer.api.microsoft.playwright.BrowserContext#setDefaultTimeout
     * BrowserContext.setDefaultTimeout()} or {@link selineer.api.microsoft.playwright.Page#setDefaultTimeout Page.setDefaultTimeout()}
     * methods.
     */
    public Double timeout;
   ...
   * }</pre>
   *
   * <p> <strong>NOTE:</strong> The order of evaluation of multiple scripts installed via {@link selineer.api.microsoft.playwright.BrowserContext#addInitScript
   * BrowserContext.addInitScript()} and {@link selineer.api.microsoft.playwright.Page#addInitScript Page.addInitScript()} is not
   * defined.
   *
   ...
   * <li> Use {@link selineer.api.microsoft.playwright.Page#mouse Page.mouse()} to click in the center of the element.</li>
   ...
   * unless {@code force} option is set. If the element is detached during the checks, the whole action is retried.</li>
   * <li> Scroll the element into view if needed.</li>
   * <li> Use {@link selineer.api.microsoft.playwright.Page#mouse Page.mouse()} to click in the center of the element, or the specified
   * {@code position}.</li>
   ...
   * manually via {@link selineer.api.microsoft.playwright.Page#onDialog Page.onDialog()} event.
   *
   * @since v1.8
   */
  default void close() {
   ...
   * unless {@code force} option is set. If the element is detached during the checks, the whole action is retried.</li>
   * <li> Scroll the element into view if needed.</li>
   * <li> Use {@link selineer.api.microsoft.playwright.Page#mouse Page.mouse()} to double click in the center of the element, or the
   ...
   * selineer.api.microsoft.playwright.Page#evalOnSelector Page.evalOnSelector()} would wait for the promise to resolve and return its
   * value.
   *
   * <p> <strong>Usage</strong>
   * <pre>{@code
   ...
   * <p> If {@code expression} returns a <a
   * href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise'>Promise</a>, then {@link
   * selineer.api.microsoft.playwright.Page#evalOnSelectorAll Page.evalOnSelectorAll()} would wait for the promise to resolve and
   * return its value.
   *
   * <p> <strong>Usage</strong>
   * <pre>{@code
   ...
   *
   * <p> If the function passed to the {@link selineer.api.microsoft.playwright.Page#evaluate Page.evaluate()} returns a <a
   * href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise'>Promise</a>, then {@link
   * selineer.api.microsoft.playwright.Page#evaluate Page.evaluate()} would wait for the promise to resolve and return its value.
   *
   * <p> If the function passed to the {@link selineer.api.microsoft.playwright.Page#evaluate Page.evaluate()} returns a
   * non-[Serializable] value, then {@link selineer.api.microsoft.playwright.Page#evaluate Page.evaluate()} resolves to {@code
   ...
   * }</pre>
   *
   * <p> {@code ElementHandle} instances can be passed as an argument to the {@link selineer.api.microsoft.playwright.Page#evaluate
   * Page.evaluate()}:
   * <pre>{@code
   ...
   *
   * <p> The only difference between {@link selineer.api.microsoft.playwright.Page#evaluate Page.evaluate()} and {@link
   * selineer.api.microsoft.playwright.Page#evaluateHandle Page.evaluateHandle()} is that {@link
   * selineer.api.microsoft.playwright.Page#evaluateHandle Page.evaluateHandle()} returns {@code JSHandle}.
   *
   * <p> If the function passed to the {@link selineer.api.microsoft.playwright.Page#evaluateHandle Page.evaluateHandle()} returns a <a
   * href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise'>Promise</a>, then {@link
   * selineer.api.microsoft.playwright.Page#evaluateHandle Page.evaluateHandle()} would wait for the promise to resolve and return its
   * value.
   *
   * <p> <strong>Usage</strong>
   * <pre>{@code
   ...
   * }</pre>
   *
   * <p> {@code JSHandle} instances can be passed as an argument to the {@link selineer.api.microsoft.playwright.Page#evaluateHandle
   * Page.evaluateHandle()}:
   * <pre>{@code
   ...
   *
   * <p> See {@link selineer.api.microsoft.playwright.BrowserContext#exposeBinding BrowserContext.exposeBinding()} for the context-wide
   * version.
   *
   * <p> <strong>NOTE:</strong> Functions installed via {@link selineer.api.microsoft.playwright.Page#exposeBinding Page.exposeBinding()} survive navigations.
   *
   * <p> <strong>Usage</strong>
   *
   ...
   * awaited.
   *
   * <p> See {@link selineer.api.microsoft.playwright.BrowserContext#exposeFunction BrowserContext.exposeFunction()} for context-wide
   * exposed function.
   *
   * <p> <strong>NOTE:</strong> Functions installed via {@link selineer.api.microsoft.playwright.Page#exposeFunction Page.exposeFunction()} survive navigations.
   *
   * <p> <strong>Usage</strong>
   *
   ...
   * selineer.api.microsoft.playwright.Selectors#setTestIdAttribute Selectors.setTestIdAttribute()} to configure a different test id
   ...
   * unless {@code force} option is set. If the element is detached during the checks, the whole action is retried.</li>
   * <li> Scroll the element into view if needed.</li>
   * <li> Use {@link selineer.api.microsoft.playwright.Page#mouse Page.mouse()} to hover over the center of the element, or the specified
   * {@code position}.</li>
   * </ol>
   *
   * <p> When all steps combined have not finished during the specified {@code timeout}, this method throws a {@code
   ...
   * media, call {@link selineer.api.microsoft.playwright.Page#emulateMedia Page.emulateMedia()} before calling {@code page.pdf()}:
   *
   ...
   * your normal test flow, instead of using {@link selineer.api.microsoft.playwright.Page#addLocatorHandler
  ...
  /**
   * Removes all locator handlers added by {@link selineer.api.microsoft.playwright.Page#addLocatorHandler Page.addLocatorHandler()}
   * for a specific locator.
   *
   * @param locator Locator passed to {@link selineer.api.microsoft.playwright.Page#addLocatorHandler Page.addLocatorHandler()}.
   * @since v1.44
   */
   ...
   * selineer.api.microsoft.playwright.BrowserContext#request BrowserContext.request()} on the page's context. See {@link
   * selineer.api.microsoft.playwright.BrowserContext#request BrowserContext.request()} for more details.
   *
   * @since v1.16
   */
   ...
   *
   * <p> <strong>NOTE:</strong> {@link selineer.api.microsoft.playwright.Page#route Page.route()} will not intercept requests intercepted by Service Worker. See
   ...
   *
   * <p> <strong>NOTE:</strong> {@link selineer.api.microsoft.playwright.Page#route Page.route()} will not intercept the first request of a popup page. Use
   * {@link selineer.api.microsoft.playwright.BrowserContext#route BrowserContext.route()} instead.
   *
   * <p> <strong>Usage</strong>
   *
   ...
   * selineer.api.microsoft.playwright.BrowserContext#route BrowserContext.route()}) when request matches both handlers.
   *
   * <p> To remove a route with its handler you can use {@link selineer.api.microsoft.playwright.Page#unroute Page.unroute()}.
   *
   ...
   * <ul>
   * <li> {@link selineer.api.microsoft.playwright.Page#goBack Page.goBack()}</li>
   * <li> {@link selineer.api.microsoft.playwright.Page#goForward Page.goForward()}</li>
   * <li> {@link selineer.api.microsoft.playwright.Page#navigate Page.navigate()}</li>
   * <li> {@link selineer.api.microsoft.playwright.Page#reload Page.reload()}</li>
   * <li> {@link selineer.api.microsoft.playwright.Page#setContent Page.setContent()}</li>
   * <li> {@link selineer.api.microsoft.playwright.Page#waitForNavigation Page.waitForNavigation()}</li>
   * <li> {@link selineer.api.microsoft.playwright.Page#waitForURL Page.waitForURL()}</li>
   * </ul>
   *
   * <p> <strong>NOTE:</strong> {@link selineer.api.microsoft.playwright.Page#setDefaultNavigationTimeout Page.setDefaultNavigationTimeout()} takes priority over
   * {@link selineer.api.microsoft.playwright.Page#setDefaultTimeout Page.setDefaultTimeout()}, {@link
   * selineer.api.microsoft.playwright.BrowserContext#setDefaultTimeout BrowserContext.setDefaultTimeout()} and {@link
   * selineer.api.microsoft.playwright.BrowserContext#setDefaultNavigationTimeout BrowserContext.setDefaultNavigationTimeout()}.
   *
   ...
   *
   * <p> <strong>NOTE:</strong> {@link selineer.api.microsoft.playwright.Page#setDefaultNavigationTimeout Page.setDefaultNavigationTimeout()} takes priority over
   * {@link selineer.api.microsoft.playwright.Page#setDefaultTimeout Page.setDefaultTimeout()}.
   *
   ...
   *
   * <p> <strong>NOTE:</strong> {@link selineer.api.microsoft.playwright.Page#setExtraHTTPHeaders Page.setExtraHTTPHeaders()} does not guarantee the order of
   ...
   *
   * <p> {@link selineer.api.microsoft.playwright.Page#setViewportSize Page.setViewportSize()} will resize the page. A lot of websites
   * don't expect phones to change size, so you should set the viewport size before navigating to the page. {@link
   * selineer.api.microsoft.playwright.Page#setViewportSize Page.setViewportSize()} will also reset {@code screen} size, use {@link
   ...
   * unless {@code force} option is set. If the element is detached during the checks, the whole action is retried.</li>
   * <li> Scroll the element into view if needed.</li>
   * <li> Use {@link selineer.api.microsoft.playwright.Page#touchscreen Page.touchscreen()} to tap the center of the element, or the
   * specified {@code position}.</li>
   * </ol>
   *
   * <p> When all steps combined have not finished during the specified {@code timeout}, this method throws a {@code
   * TimeoutError}. Passing zero timeout disables this.
   *
   * <p> <strong>NOTE:</strong> {@link selineer.api.microsoft.playwright.Page#tap Page.tap()} the method will throw if {@code hasTouch} option of the browser
   * context is false.
   *
   * @param selector A selector to search for an element. If there are multiple elements satisfying the selector, the first will be used.
   * @since v1.8
  ...
  /**
   * Removes all routes created with {@link selineer.api.microsoft.playwright.Page#route Page.route()} and {@link
   * selineer.api.microsoft.playwright.Page#routeFromHAR Page.routeFromHAR()}.
   *
   * @since v1.41
   */
  void unrouteAll();
  /**
   * Removes a route created with {@link selineer.api.microsoft.playwright.Page#route Page.route()}. When {@code handler} is not
   ...
   * truthy value. Will throw an error if the page is closed before the {@link selineer.api.microsoft.playwright.Page#onConsoleMessage
   ...
   * <p> <strong>Usage</strong>
   *
   * <p> The {@link selineer.api.microsoft.playwright.Page#waitForFunction Page.waitForFunction()} can be used to observe viewport size
   * change:
   * <pre>{@code
   * import com.microsoft.playwright.*;
   *
   ...
   * }</pre>
   *
   * <p> To pass an argument to the predicate of {@link selineer.api.microsoft.playwright.Page#waitForFunction Page.waitForFunction()}
   * function:
   * <pre>{@code
   * String selector = ".foo";
  ...
  /**
   * @deprecated This method is inherently racy, please use {@link selineer.api.microsoft.playwright.Page#waitForURL Page.waitForURL()} instead.
   *
   * @param callback Callback that performs the action triggering the event.
   * @since v1.8
   */
   ...
   * an error if the page is closed before the {@link selineer.api.microsoft.playwright.Page#onRequestFinished
