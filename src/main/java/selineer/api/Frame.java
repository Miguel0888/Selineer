 ...
 */
 ...
 /**
  * At every point of time, page exposes its current frame tree via the {@link selineer.api.microsoft.playwright.Page#mainFrame
  * Page.mainFrame()} and {@link selineer.api.microsoft.playwright.Frame#childFrames Frame.childFrames()} methods.
  *
  * <p> {@code Frame} object's lifecycle is controlled by three events, dispatched on the page object:
  * <ul>
  * <li> {@link selineer.api.microsoft.playwright.Page#onFrameAttached Page.onFrameAttached()} - fired when the frame gets attached to the
  * page. A Frame can be attached to the page only once.</li>
  * <li> {@link selineer.api.microsoft.playwright.Page#onFrameNavigated Page.onFrameNavigated()} - fired when the frame commits navigation
  * to a different URL.</li>
  * <li> {@link selineer.api.microsoft.playwright.Page#onFrameDetached Page.onFrameDetached()} - fired when the frame gets detached from
 ...
 public interface Frame {
   ...
   class IsHiddenOptions {
     ...
     public Boolean strict;
     /**
      * @deprecated This option is ignored. {@link selineer.api.microsoft.playwright.Frame#isHidden Frame.isHidden()} does not wait for the element
   ...
   class IsVisibleOptions {
     ...
     public Boolean strict;
     /**
      * @deprecated This option is ignored. {@link selineer.api.microsoft.playwright.Frame#isVisible Frame.isVisible()} does not wait for the element
    ...
    * selineer.api.microsoft.playwright.Frame#evalOnSelector Frame.evalOnSelector()} would wait for the promise to resolve and return
    * its value.
    *
    * <p> <strong>Usage</strong>
    * <pre>{@code
    ...
    * <p> If {@code expression} returns a <a
    * href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise'>Promise</a>, then {@link
    * selineer.api.microsoft.playwright.Frame#evalOnSelectorAll Frame.evalOnSelectorAll()} would wait for the promise to resolve and
    * return its value.
    *
    * <p> <strong>Usage</strong>
    * <pre>{@code
    ...
    * Returns the return value of {@code expression}.
    *
    * <p> If the function passed to the {@link selineer.api.microsoft.playwright.Frame#evaluate Frame.evaluate()} returns a <a
    * href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise'>Promise</a>, then {@link
    * selineer.api.microsoft.playwright.Frame#evaluate Frame.evaluate()} would wait for the promise to resolve and return its value.
    *
    * <p> If the function passed to the {@link selineer.api.microsoft.playwright.Frame#evaluate Frame.evaluate()} returns a
    * non-[Serializable] value, then {@link selineer.api.microsoft.playwright.Frame#evaluate Frame.evaluate()} returns {@code
    ...
    * }</pre>
    *
    * <p> {@code ElementHandle} instances can be passed as an argument to the {@link selineer.api.microsoft.playwright.Frame#evaluate
    * Frame.evaluate()}:
    * <pre>{@code
    ...
    *
    * <p> The only difference between {@link selineer.api.microsoft.playwright.Frame#evaluate Frame.evaluate()} and {@link
    * selineer.api.microsoft.playwright.Frame#evaluateHandle Frame.evaluateHandle()} is that {@link
    * selineer.api.microsoft.playwright.Frame#evaluateHandle Frame.evaluateHandle()} returns {@code JSHandle}.
    *
    * <p> If the function, passed to the {@link selineer.api.microsoft.playwright.Frame#evaluateHandle Frame.evaluateHandle()}, returns a
    * <a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise'>Promise</a>, then
    * {@link selineer.api.microsoft.playwright.Frame#evaluateHandle Frame.evaluateHandle()} would wait for the promise to resolve and
    * return its value.
    *
    * <p> <strong>Usage</strong>
    * <pre>{@code
    ...
    * }</pre>
    *
    * <p> {@code JSHandle} instances can be passed as an argument to the {@link selineer.api.microsoft.playwright.Frame#evaluateHandle
    ...
    * <p> <strong>Usage</strong>
    *
    * <p> The {@link selineer.api.microsoft.playwright.Frame#waitForFunction Frame.waitForFunction()} can be used to observe viewport size
    * change:
    * <pre>{@code
    * import com.microsoft.playwright.*;
    *
   ...
   /**
    * @deprecated This method is inherently racy, please use {@link selineer.api.microsoft.playwright.Frame#waitForURL Frame.waitForURL()} instead.
    *
