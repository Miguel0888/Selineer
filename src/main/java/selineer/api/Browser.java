...
/**
 * A Browser is created via {@link selineer.api.microsoft.playwright.BrowserType#launch BrowserType.launch()}. An example of using a
...
public interface Browser extends AutoCloseable {
  ...
  class NewContextOptions {
    ...
    /**
     * When using {@link selineer.api.microsoft.playwright.Page#navigate Page.navigate()}, {@link selineer.api.microsoft.playwright.Page#route
     * Page.route()}, {@link selineer.api.microsoft.playwright.Page#waitForURL Page.waitForURL()}, {@link
     * selineer.api.microsoft.playwright.Page#waitForRequest Page.waitForRequest()}, or {@link
     * selineer.api.microsoft.playwright.Page#waitForResponse Page.waitForResponse()} it takes the base URL in consideration by using
     ...
     * feature, supported values are {@code "light"} and {@code "dark"}. See {@link selineer.api.microsoft.playwright.Page#emulateMedia
     ...
     * selineer.api.microsoft.playwright.Page#emulateMedia Page.emulateMedia()} for more details. Passing {@code null} resets emulation
     ...
     * selineer.api.microsoft.playwright.BrowserContext#grantPermissions BrowserContext.grantPermissions()} for more details. Defaults
     * to none.
     */
     ...
     * selineer.api.microsoft.playwright.BrowserContext#close BrowserContext.close()} for the HAR to be saved.
     */
    public Path recordHarPath;
    public Object recordHarUrlFilter;
    /**
     * Enables video recording for all pages into the specified directory. If not specified videos are not recorded. Make sure
     * to call {@link selineer.api.microsoft.playwright.BrowserContext#close BrowserContext.close()} for videos to be saved.
     */
     ...
     * See {@link selineer.api.microsoft.playwright.Page#emulateMedia Page.emulateMedia()} for more details. Passing {@code null} resets
     ...
     * obtained via {@link selineer.api.microsoft.playwright.BrowserContext#storageState BrowserContext.storageState()}.
     */
    public String storageState;
    /**
     * Populates context with given storage state. This option can be used to initialize context with logged-in information
     * obtained via {@link selineer.api.microsoft.playwright.BrowserContext#storageState BrowserContext.storageState()}. Path to the
  ...
  /**
   * In case this browser is obtained using {@link selineer.api.microsoft.playwright.BrowserType#launch BrowserType.launch()}, closes
   ...
   * {@link selineer.api.microsoft.playwright.BrowserContext#close BrowserContext.close()} on any {@code BrowserContext} instances you
   ...
   * context via {@link selineer.api.microsoft.playwright.BrowserContext#close BrowserContext.close()} when your code is done with the
   ...
   * followed by the {@link selineer.api.microsoft.playwright.BrowserContext#newPage BrowserContext.newPage()} to control their exact
   * life times.
   *
   * @since v1.8
   */
