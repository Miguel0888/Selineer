...
import selineer.adapter.PlaywrightAdapter;
 ...
 public interface Playwright extends AutoCloseable {
   ...
   void close();
   /**
    * Launches new Playwright driver process and connects to it. {@link selineer.api.microsoft.playwright.Playwright#close
   ...
   static Playwright create(CreateOptions options) {
     return PlaywrightAdapter.create(options);
   }
